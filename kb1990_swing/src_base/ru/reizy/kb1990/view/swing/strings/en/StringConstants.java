package ru.reizy.kb1990.view.swing.strings.en;
...
public interface StringConstants {
	...
	String[] CASTLE_NEED_SEIGE = { "You need seige weapon",
	...
	String[] BATTLE_RESULT_GLORY = { "Well done, %1$3s the %2$3s ,",
			"You have successfully vanquished", "yet another foe. " };
	...
	String[] ARTIFACT_FOUND_INFO = {
			"Ridding the countryside of a fercious beast, the Magistrate "
					+ "presents you with: The %1$1s...",
			"Freeing a virtuous maiden from the clutches of a despicable "
					+ "criminal, you have been granted: The %1$1s...",
			"You discover ancient scrolls that describe the patterns of"
					+ " the oceans. Mariners, in gratitude, bestow upon you: "
					+ "The %1$1s...",
			"Challenged to a joust by the dread Dark Knight, you quickly "
					+ "dispose of his and receive: The %1$1s...",
			"Im the study of a deserted wizard's tower, you have found: "
					+ "%1$1s...",
			"Resting on a throne in a phantom castle you have found: "
					+ "The %1$1s...",
			"Following rumors of a great and powerful sword, you defeat "
					+ "its fearsome guardian and gain possession of: " + "The %1$1s...",
			"Hidden within an enchanted grove, you find: The %1$1s..." };
	String ARTIFACT_FOUND_INFO_PASLE = "\n... and a piece of map to "
			+ MAIN_SEARCH_NAME + " search";
	String[] ARTIFACT_NAME = { "Ring of Heroism", "Atricles of Nobility",
			"Anchor of Admiralty", "Shield of Protection", "Book of Necros",
			"Crown of Command", "Sword of Prowess", "Amulet of Augmentation" };

	// treasures
	String TREASURE_FOUND_INFO_GOLD = "After scouring the area, you fall upon "
			+ "a hidden treasure cache. You may:\n"//
			+ " А)Take the %1$1s gold. \n"//
			+ " В)Distribute the gold to thr peasants, increasing your "
			+ "leadership by %2$1s.";
	String TREASURE_FOUND_INFO_FULL_MAP = "\nPeering through a magical orb you "
			+ "are able to view the entire continent. Your map of this area "
			+ "is complete. ";
	String TREASURE_FOUND_INFO_NEXT_MAP = "\nHidden within an ancient chest, you "
			+ "find maps and charts describing passage to %1$5s.";
	String TREASURE_FOUND_INFO_RANDOM_SPELL = "You have captured a mischievious "
			+ "imp which has been terrorizing the region. In exchange for its "
			+ "release, you receive:\n %1$1s";
	String TREASURE_FOUND_INFO_RICH_MINERAL = "After surveying the area, you "
			+ "discover that it is rich in mineral deposits. \n"
			+ "The King rewards you for your find by increasing your "
			+ "weekly income by %1$1s";
	String TREASURE_FOUND_INFO_SPELL_CAPACITY = "A tribe of nomads greet you "
			+ "and your army warmly. Their shaman, in awe of your prowess, "
			+ "teaches you the secret of his tribe's magic."
			+ "Your maximum spell capacity is increased by %1$1s";
	String TREASURE_FOUND_INFO_SPELL_POWER = "Traversing the area, you stumble "
			+ "upon a time worn canister. Curious, you unclog the bottle, releasing "
	...
	String[] KING_DIALOG = {
			"Trumpets announce your arrival with regal fanfare."
					+ "\n\n King Maximus rises from his throne "
					+ "to greet you and proclaims:           (click)",
			"My dear %1$1s, \n\n ",
			"I can aid you better after you've captured " + "%1$1s more villain%2$1s",
			"Congratulations! I now promote you to %1$1s",
	...
	String[] CONTINENTS_NAMES = { "Continentia", "Forestria", "Archipelia",
			"Saharia" };
	...
	String[] COUNTS_NAMES = { "A few", "Some", "Many", "A lot of", " A horde of",
			"A multitude of" };
